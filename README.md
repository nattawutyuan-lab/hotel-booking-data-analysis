...
* **สมมติฐาน:** * **Weekend Commission Waste:** ในช่วงวันหยุดสุดสัปดาห์ (ศุกร์–เสาร์) ที่มีความต้องการเข้าพักสูง โรงแรมอาจจ่ายค่าคอมมิชชันให้ OTA มากเกินความจำเป็นทั้งที่สามารถขายห้องเองได้
  * **Cancellation Impact:** ช่องทางหรือประเภทราคาที่มีอัตราการยกเลิกสูง ทำให้โรงแรมเสียโอกาสในการขายห้องพัก (Opportunity Cost) ให้กับลูกค้ากลุ่มอื่น
* **วิธีวิเคราะห์:** * ตรวจสอบ `Weekend Occupancy %` หากพบว่าสูงกว่า 85% (High Demand) ให้คำนวณมูลค่า `Commission Waste` จากยอดที่จองผ่าน OTA

...
* **เป้าหมาย:** ตรวจสอบคุณภาพการจอง (Booking Quality) โดยเปรียบเทียบสัดส่วนระหว่างการเข้าพักจริง (Checked-Out) และการยกเลิก (Cancelled) เพื่อระบุความน่าเชื่อถือของลูกค้าในแต่ละช่องทาง
